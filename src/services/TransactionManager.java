...
public class TransactionManager implements InterfaceCRUD<Transaction> {
        ...
        TransactionRepository.writeTransactionToFile(transactions, file_path);
        transactions.clear();

    }
    public static void readFile() {
        List<Transaction> transactions_in_file = TransactionRepository.readFileTransaction(file_path);
        transactions.clear();
